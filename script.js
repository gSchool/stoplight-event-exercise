...
} else  {document.getElementById('stopLight').style.background = 'red';
}
});
...
} else  {document.getElementById('slowLight').style.background = 'yellow';
}
});
...
} else  {document.getElementById('goLight').style.background = 'green';
}
});
document.getElementById('stopButton').addEventListener('click', function(){
    if (document.getElementById('slowLight').style.background === 'yellow'){
